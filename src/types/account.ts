...
interface IndividualAccount extends BaseAccount, ContactInfo {
  type: 'individual';
...
interface OrganizationalAccount extends BaseAccount, ContactInfo {
  type: 'organization';
...
type Account = IndividualAccount | OrganizationalAccount;
