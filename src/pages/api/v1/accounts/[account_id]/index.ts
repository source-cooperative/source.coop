 ...
 *     description: Retrieves the details of a specific account. Requires appropriate permissions.
 *     parameters:
 *       - in: path
 *         name: account_id
 *         required: true
 ...
 *     description: Disables a specific account. Requires appropriate permissions.
 *     parameters:
 *       - in: path
 *         name: account_id
 *         required: true
