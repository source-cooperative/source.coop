...
export function ObjectBrowser({
  ...
  const { focusedIndex, setFocusedIndex, selectedDataItem } = useObjectBrowserKeyboardShortcuts({
    repository,
    objects: items,
    currentPath,
    selectedObject,
  ...
  if (
    ...
    return (
      <>
        ...
        />
        <ShortcutHelp open={showHelp} onOpenChange={setShowHelp} context="object-details" />
      </>
    );
  }
  ...
  return (
    <>
      ...
      <ShortcutHelp open={showHelp} onOpenChange={setShowHelp} context="object-browser" />
    </>
  );
}
