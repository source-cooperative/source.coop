...
const footerLinks = [
  ...
  { url: "https://source.coop", display: "About", external: true },
  { url: "https://docs.source.coop", display: "Docs", external: true },
  { url: "mailto:hello@source.coop", display: "Contact", external: false },
  { url: "https://join.slack.com/t/sourcecoop/shared_invite/zt-212sakf1j-fONCD4lZ_v2HP2PDpTr2dw", display: "Slack", external: true },
  { url: "https://forms.gle/fjMpYrwpVZEaBExW6", display: "Publish Data", external: true },
