...
export function SearchBar() {
    ...
    return <Box as="form" onSubmit={handleSubmit} sx={{width: "100%"}}>
        <Grid sx={{gridGap: 3, gridTemplateColumns: "auto max-content"}}>
            <Input placeholder="Search" name="query" defaultValue={query ? query : null}/>
            <Button variant="nav" onClick={handleSubmit}>Browse</Button>
        </Grid>
    </Box>
}
