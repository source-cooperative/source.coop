            ...
            <Container>
              ...
              <Flex direction={{initial: "column", sm: "row"}} align="start" gap="8">
                <Box flexBasis="50%">
                  ...
                  <Text>
                    Data engineers, scientists, developers, and researchers
                    often spend more time fighting infrastructure than doing
                    their actual work. Commercial repositories force them to
                    become part-time system administrators—wrestling with cloud
                    configurations, scattered sources, and integration barriers
                    before productive work begins. Unpredictable costs, tricky
                    integration processes, and collaboration barriers prevent
                    the seamless sharing and reproducibility truly needed. When
                    commercial entities control access to data systems,
                    expertise gets diverted from solving global challenges to
                ...
                <Box flexBasis="50%">
                  ...
                  <Text>
                    ...
                    publish data of any kind at any scale without needing to
                    build or maintain their own infrastructure.
                    <br />
                    <br />
                  ...
                  <Flex direction="column" gap="6" style={{ flex: 1 }}>
                    ...
                    >
                      ...
                      <Box>
                        ...
                        <Text size="1">
                          No opaque pricing calculators. No surprise egress
                          fees. Source offers free use for small to large
                          datasets and a straightforward cost structure that
                          reinvests back into the platform—not profits.
                        </Text>
                      </Box>
                    </Flex>
